  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
           SimpleCard(titulo: 'Capitulo 1 - A maneira como o mundo funciona esta errada!', card_color: Colors.red, items: [
            ...
            SimpleCard(titulo: 'Como ser o Super Produtivo', card_color: Colors.red, items: ['Scrum','Week Planner','Horario de estudo + Horario de trabalho', 'Ter clareza das prioridades no dia!', 'Ter Metas com datas Reais!', '- Saber lidar com Imprevistos!']),
